...
const GrocerrySection = () => {
  const data = useSelector((state) => state.product.productInfo);

  const getGrocerry = data.productData.find(
  ...
  return (
    <div className="w-full h-fit">
      <div className="px-3">
        {getGrocerry.items?.map((Element, id) => (
          <div>
            {/* header part  */}
...
export default GrocerrySection;
